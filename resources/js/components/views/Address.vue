          ...
          <div class="card">
            <div class="card-header">
              ...
              <a 
                ...
                <i v-if="!newAddress" id="brand-toggle" class="fas fa-plus"></i>
            ...
            <div class="card-body p-0">
              ...
              <table class="table table-sm table-striped table-hover">
                ...
                <tbody>
                  <tr class="text-center" v-for="address in filterAddresses">
              ...
              <nav v-if="!address_nameSearch" aria-label="Page navigation example" class="mx-2">
                <ul class="pagination pagination-sm">
                  <li 
                    ...
                    <a @click.prevent="addressPaginate(page)" class="page-link" href="#">
                      {{page}}
                    </a>
                  </li>
                </ul>
              ...
              <nav v-if="!area_nameSearch" aria-label="Page navigation example" class="mx-2">
                <ul class="pagination pagination-sm">
                  <li 
                    ...
                    <a @click.prevent="areaPaginate(page)" class="page-link" href="#">
                      {{page}}
                    </a>
                  </li>
                </ul>
      ...
      filterAddresses: function(){  
        if(this.address_nameSearch != ''){
          return this.allAddresses.filter((item) => 
              item.nombre.toUpperCase().includes(this.address_nameSearch.toUpperCase()) 
            );          
        }else{
