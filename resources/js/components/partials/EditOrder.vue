					...
					<div class="col-6">
						<div class="form-group">
							...
							<select class="custom-select" required>
								...
								<option v-for="device in devices" :selected="device.nombre === equipo.nombre" :value="device.identificador">{{device.nombre}}</option>
							</select>
						</div>
					</div>
					...
					<div class="col-6">
						<div class="form-group">
							...
							<select class="custom-select" required>
								...
								<option v-for="brand in brands" :selected="brand.nombre === equipo.marca" :value="brand.identificador">{{brand.nombre}}</option>
							</select>
						</div>
					</div>
